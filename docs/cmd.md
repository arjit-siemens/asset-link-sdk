...
- The iah_base_v0.9.0.yaml is used as the base schema for validation, which can be found [here](https://github.com/industrial-asset-hub/asset-link-sdk/tree/main/model).
